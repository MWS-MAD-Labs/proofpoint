-- ============================================================
-- Fix: Add gen_random_uuid() as database-level default for all
--      TEXT id columns that were missing a DEFAULT clause.
--
-- Root cause: Prisma's @default(uuid()) is application-level only.
-- The initial migration.sql generated TEXT NOT NULL with no DEFAULT,
