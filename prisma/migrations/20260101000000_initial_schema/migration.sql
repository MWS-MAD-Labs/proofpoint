...
-- Creates all base tables for ProofPoint Dashboard
-- ============================================================
...
ALTER TABLE "rubric_templates" ADD CONSTRAINT "rubric_templates_department_id_fkey"
    FOREIGN KEY ("department_id") REFERENCES "departments"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "rubric_templates" ADD CONSTRAINT "rubric_templates_created_by_fkey"
...
ALTER TABLE "rubric_sections" ADD CONSTRAINT "rubric_sections_template_id_fkey"
    FOREIGN KEY ("template_id") REFERENCES "rubric_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "rubric_indicators" ADD CONSTRAINT "rubric_indicators_section_id_fkey"
    FOREIGN KEY ("section_id") REFERENCES "rubric_sections"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "kpi_domains" ADD CONSTRAINT "kpi_domains_template_id_fkey"
    FOREIGN KEY ("template_id") REFERENCES "rubric_templates"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "kpi_standards" ADD CONSTRAINT "kpi_standards_domain_id_fkey"
    FOREIGN KEY ("domain_id") REFERENCES "kpi_domains"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "kpis" ADD CONSTRAINT "kpis_standard_id_fkey"
    FOREIGN KEY ("standard_id") REFERENCES "kpi_standards"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "department_roles" ADD CONSTRAINT "department_roles_department_id_fkey"
    FOREIGN KEY ("department_id") REFERENCES "departments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "department_roles" ADD CONSTRAINT "department_roles_default_template_id_fkey"
    FOREIGN KEY ("default_template_id") REFERENCES "rubric_templates"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "approval_workflows" ADD CONSTRAINT "approval_workflows_department_role_id_fkey"
    FOREIGN KEY ("department_role_id") REFERENCES "department_roles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "assessments" ADD CONSTRAINT "assessments_manager_id_fkey"
    FOREIGN KEY ("manager_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "assessments" ADD CONSTRAINT "assessments_director_id_fkey"
    FOREIGN KEY ("director_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "assessments" ADD CONSTRAINT "assessments_template_id_fkey"
    FOREIGN KEY ("template_id") REFERENCES "rubric_templates"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "assessments" ADD CONSTRAINT "assessments_returned_by_fkey"
...
ALTER TABLE "assessment_questions" ADD CONSTRAINT "assessment_questions_indicator_id_fkey"
    FOREIGN KEY ("indicator_id") REFERENCES "rubric_indicators"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "assessment_questions" ADD CONSTRAINT "assessment_questions_asked_by_fkey"
    FOREIGN KEY ("asked_by") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "assessment_questions" ADD CONSTRAINT "assessment_questions_responded_by_fkey"
